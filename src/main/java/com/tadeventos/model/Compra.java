...
public class Compra {
    ...
    public String toString() {
        return "Evento [idCompra=" + idCompra + ", evento_idevento=" + evento_idevento + ", numero_cartao=" + numero_cartao + ", bandeira=" + bandeira + ", data_vencimento=" + data_vencimento + ", digito_validador=" + digito_validador + ", user=" + user + "]";
    }
