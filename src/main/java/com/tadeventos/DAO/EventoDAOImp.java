...
public class EventoDAOImp  implements EventoDAO {
  ...
  @Override public void AddEvento(Evento evento) {
    ...
    @Override public void DeleteEvento(Long idevento)   {
    ...
    @Override public void EditEvento(Evento evento){
    ...
    @Override public Evento GetEvento(Long idevento){
    ...
    @Override public List GetAllEventos() {
       return Busca("");
    }
