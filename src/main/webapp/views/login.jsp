...
<div class="container ">
    ...
    <form method="POST" action="${contextPath}/LoginController" class="form-signin">
        ...
        <div class="form-group ${error != null ? 'has-error' : ''} form-out">
            ...
            <h4 class="text-center"><a href="${contextPath}/views/registration.jsp">Criar uma nova conta</a></h4>
