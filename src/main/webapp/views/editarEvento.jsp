...
<html>
    ...
    <body id="home">
        ...
        <div class="ui container">
            <form action="/TadEventosS/eventos/editar"  id="eventoform" method="post" modelAttribute="eventoForm">
                <div class="ui form">
                    <input type="hidden" name="idevento" value="${evento.id}">

                    <div class="field">
                        <label path="titulo">Título</label>
                        <input path="titulo" name="titulo" required="" placeholder="" id="titulo" value="${evento.titulo}"  />
                    </div>

                    <div class="field">
                        <label path="descricao">Descrição do Evento</label>
                        <textarea name="descricao" path="descricao" type="textarea" id="descicao" required="" >${evento.descricao}</textarea >
                    </div>

                    <div class="field">
                        <label path="preco_entrada" required="">Preco unitário do ingresso</label>
                        <input name="preco_entrada" path="preco_entrada" type="number"  min="1" step="any" required="" value="${evento.precoEntrada}" />
                    </div>

                    <div class="two fields">
                        <div class="field">
                            <label path="datainicio">Início do evento</label>
                                    ...
                                    <div class='col-sm-6'>
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker1'>
                                                <input path="datainicio" name="datainicio" id="datainicio" type="text" name="daterange" required="" value="${evento.dataInicio}" />
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class='col-sm-6'>
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker1'>
                                                <input path="datafim" name="datafim" id="datafim" type="text" name="daterange" required="" value="${evento.dataFim}" />
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div>
                    ...
                    <div class="field">
                        ...
                        <input name="endereco"  id="geocomplete" name="geocomplete" type="text" placeholder="Local"  value="${evento.endereco}"  required="" />
                    </div>
                </div>
