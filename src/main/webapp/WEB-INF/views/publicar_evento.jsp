        ...
        <p></p> <div class="ui container">
            <form:form action="${GravarEvento}"  id="eventoform" method="post" modelAttribute="eventoForm">
                ...
                <div class="ui form">
                    ...
                    <div class="field">
                        <form:label path="preco_entrada" required="">Preco unitário do ingresso</form:label>
                ...
                <div class="two fields">
                                ...
                                <div class="row">
                                    <div class='col-sm-6'>
                                        <div class="form-group">
                                            ...
                                            <form:input path="datainicio" id="datainicio" type="text" name="daterange" required="" />
                    ...
                    <div class="field">
                        <form:label path="datafim">Fim do evento</form:label>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class='col-sm-6'>
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker1'>
                                            <form:input path="datafim" id="datafim" type="text" name="daterange" required="" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
